      ...
      <main className={styles.main}>
        ...
        <Collapse.Group width="300">
          <Collapse title="What is StudyBuddy?">
            <Text>
              StudyBuddy is a platform that will allow you to connect with a classmate that 
              would like to study together. 
            </Text>
          </Collapse>
          <Collapse title="How does it work?">
            <Text>
              Simply enter your classes and look for a buddy that is available to 
              connect with. Each class contains a list of buddies that will show contact
              information. Just reach out and message them to study together!
            </Text>
          </Collapse>
        </Collapse.Group>
      </main>
